...
test('list - error', t => {
  ...
  getPkg.withArgs(6).returns(Promise.reject('connection error'))
  getPkg.withArgs(7).returns(Promise.reject('connection error'))
  getPkg.withArgs(8).returns(Promise.reject('connection error'))
  getPkg.withArgs(9).returns(Promise.reject('connection error'))
  getPkg.withArgs(10).returns(Promise.reject('connection error'))
  getPkg.withArgs(99).returns(Promise.reject('connection error'))

  list.get('API-TOKEN')
    .catch(error => {
      t.equal(error, 'connection error', 'error is as expected')
      t.end()
